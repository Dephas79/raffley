defmodule RaffleyWeb.RaffleLive.Index do
  ...
  def mount(_params, _session, socket) do
    ...
    #     IO.inspect(socket.assigns.streams.raffles, label: "AFTER-MOUNT")
    #     socket
    #   end)
  ...
  def render(assigns) do
    ...
    <div class="raffle-index">
      <.banner :if={false}>
        <.icon name="hero-sparkles-solid" /> Mystry Event Coming Soon!
        <:details :let={vibe}>
  ...
  def filter_form(assigns) do
    ...
    <.form for={@form} id="filter-form" phx-change="filter">
      <.input field={@form[:q]} placeholder="Sreach..." autocomplete="off" phx-debounce="500" />
